...
const mainHeader = document.querySelectorAll('.main-content p' );
...
mainHeader[0].textContent = siteContent['main-content']['features-content'];
mainHeader[1].textContent = siteContent['main-content']['about-content'];
mainHeader[2].textContent = siteContent['main-content']['services-content'];
mainHeader[3].textContent = siteContent['main-content']['product-content'];
